...
# Unit tests for the different geometry classes (Object subclasses)
...
$CPP -o test_runner_config test_runner_config.cpp geometry.cpp  -I. -I/usr/local/include -I$CXXTEST
if [ $? -eq 0 ]
then
