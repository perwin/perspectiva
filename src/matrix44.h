// Class for 4x4 matrix, from scratchapixel.com
// http://www.scratchapixel.com/code.php?id=22&origin=/lessons/mathematics-physics-for-computer-graphics/geometry
...
// for() loops contained in the first fragment. It is supposed to be
// faster, however considering matrix multiplicatin is not necessarily that
// common, this is probably not super useful nor really necessary (but nice
...
// account for translation (m[3][0], m[3][1], m[3][2]) and we don't compute w.
  template<typename S> 
...
// Compute the inverse of the matrix using the Gauss-Jordan (or reduced
// row) elimination method. We didn't explain in the lesson on MATRIX_44 how
// the inverse of matrix can be found. Don't worry at this point if you
// don't understand how this works. But we will need to be able to compute
// the inverse of matrices in the first lessons of the "Foundation of 3D
